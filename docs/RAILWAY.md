...
Each **web deploy** starts the app immediately, runs one schedule-gated sync, and
launches a **background sync watcher** that keeps 15-minute live refresh during
PL fixtures even if sync-cron misses ticks.
